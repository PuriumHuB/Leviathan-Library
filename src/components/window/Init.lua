...
return function(Config)
	...
	function Window:Open()
		...
		task.spawn(function()
			...
			-- Leviathan: spring open — start tiny, spring to full size
			Window.UIElements.Main.Size = UDim2.new(Window.Size.X.Scale, Window.Size.X.Offset, 0, 60)
			if not Window.UIElements.Main:FindFirstChild("LevScale") then
				local sc = Instance.new("UIScale"); sc.Scale = 0.88; sc.Name = "LevScale"
				sc.Parent = Window.UIElements.Main
			end
			Window.UIElements.Main.LevScale.Scale = 0.88

			Tween(Window.UIElements.Main, 0.55, {
				Size = Window.Size,
			}, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()
			Tween(Window.UIElements.Main.LevScale, 0.50, {
				Scale = 1,
			}, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()
	...
	function Window:Close()
		...
		-- Leviathan: spring close — scale down then collapse
		if Window.UIElements.Main:FindFirstChild("LevScale") then
			Tween(Window.UIElements.Main.LevScale, 0.20, {
				Scale = 0.92,
			}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
		end
		task.delay(0.08, function()
			Tween(Window.UIElements.Main, 0.40, {
				Size = UDim2.new(Window.Size.X.Scale, Window.Size.X.Offset, 0, 0),
			}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
		end)
		if Window.UIElements.BackgroundGradient then
