return function(Creator)
	return {
		...
		-- Box / BoxBorder defaults:
		--   SectionBoxBackground: very subtle tinted fill
		--   SectionBoxBorder: uses "Button" colour so it inherits
		--     the accent from every theme automatically
		SectionBox = "Text",
